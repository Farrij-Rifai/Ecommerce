            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="gambar_detail" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == gambar_detail ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == gambar_detail ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == gambar_detail ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == gambar_detail ? 'active' : ''"
                    >
              ...
              <div class="col-lg-6">
                <div class="product-details text-left">
                  ...
                  <div class="quantity">
                    <router-link to="/cart">
                      <i class="primary-btn pd-cart">Add To Cart</i>
                    </router-link>
                  </div>
                </div>
              </div>
...
import Com_RelatedShayna from "@/components/Com_RelatedProduct.vue";
